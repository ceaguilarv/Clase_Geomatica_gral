...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" type="Local Area Network" name="Shapefile" url="file://\\PC\C$\TEXTOS\proyectos\pinnova2002.uam\Libro_ArcGIS_Ver_0.3\CD_DATOS\Parte8\mfebelvis" format="" description="" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
